      ...
      <div className="flex items-center gap-2">
        ...
        <div className="relative hidden md:block">
          ...
          <input
            ...
            className="h-9 w-64 rounded-lg border border-border bg-secondary pl-9 pr-4 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring"
          />
        </div>
