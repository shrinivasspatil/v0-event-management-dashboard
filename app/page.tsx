        ...
        <div className="relative z-10 flex flex-col justify-center px-12 xl:px-20">
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-8">
              ...
              <span className="text-2xl font-bold text-primary-foreground">Eventify</span>
            </div>
            ...
            <p className="text-lg text-primary-foreground/80 leading-relaxed max-w-md">
              Create, manage, and analyze your events all in one place. From ticketing to attendee management, we have got you covered.
            </p>
          </div>
          <div className="flex items-center gap-6 mt-8">
            <div className="text-center">
              <div className="text-3xl font-bold text-primary-foreground">10k+</div>
              <div className="text-sm text-primary-foreground/70">Events Created</div>
            </div>
            <div className="w-px h-12 bg-primary-foreground/20" />
            <div className="text-center">
              <div className="text-3xl font-bold text-primary-foreground">500k+</div>
              <div className="text-sm text-primary-foreground/70">Tickets Sold</div>
            </div>
            <div className="w-px h-12 bg-primary-foreground/20" />
            <div className="text-center">
